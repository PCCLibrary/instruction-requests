...
class InstructionRequestForm extends Component
{
    ...
    protected $rules = [
        ...
        'formData.class_syllabus.*' => 'nullable|file|mimes:txt,rtf,pdf,doc,docx,ppt,pptx,pot,potx,pps,ppsx,odp|max:40960',
        'formData.instructor_attachments.*' => 'nullable|file|mimes:txt,rtf,pdf,doc,docx,ppt,pptx,pot,potx,pps,ppsx,odp|max:40960',
