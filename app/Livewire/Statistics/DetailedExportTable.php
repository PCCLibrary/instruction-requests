...
final class DetailedExportTable extends PowerGridComponent
{
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            ->add('librarian_name')
            ->add('room')
            ->add('genai_discussion_interest', fn (InstructionRequests $model) =>
                !empty($model->genai_discussion_interest) ? 'Yes' : 'No')
    ...
    public function columns(): array
    {
        ...
        if (in_array('genai_discussion_interest', $this->visibleColumns)) {
            $columns[] = Column::make('GenAI Discussion Interest', 'genai_discussion_interest')
                ->sortable();
        }
