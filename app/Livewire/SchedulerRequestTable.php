...
final class SchedulerRequestTable extends PowerGridComponent
{
    use WithExport;

    // Define table properties - unique table name for scheduler
    public string $tableName = 'scheduler_requests.instruction_requests';
    ...
    /**
     * Set PowerGrid table header color to match filter panel
     */
    ...
    public function setUp(): array
    {
        ...
        return [
            ...
            (new Exportable('scheduler_requests_' . now()->format('Y-m-d')))
    ...
    public function datasource(): Builder
    {
        return InstructionRequests::query()
            ...
            ->select([
                ...
                'instruction_request_details.assigned_librarian_id',
...
//                ->operators(['contains']),
    ...
    public function filterNoPreference(): void
    {
        ...
        // Apply assigned librarian filter for "No Librarian Preference" (user_id = 2)
