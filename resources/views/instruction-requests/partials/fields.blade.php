...
<div class="mb-4">
    ...
    <select id="assigned_librarian_id" name="assigned_librarian_id"
            class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        @foreach($librarians as $librarian)
            <option
                value="{{ $librarian->id }}" {{ $instructionRequest->detail->assigned_librarian_id == $librarian->id ? 'selected' : '' }}>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Schedule
                                    Calendar Event</h3>
                                <div class="mt-2">
