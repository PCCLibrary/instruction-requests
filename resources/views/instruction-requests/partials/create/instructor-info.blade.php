...
<x-fieldset legend="Instructor Information" classes="bg-white dark:bg-gray-800 dark:border-gray-700">
    <div x-data="{ openModal: false }" class="space-y-6">
        ...
        <div class="mb-4">
            <button
                ...
                class="inline-flex items-center px-3 py-2 border border-gray-300 dark:border-gray-700 shadow-sm text-sm leading-4 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-800"
            >
