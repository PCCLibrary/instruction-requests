...
return [
    ...
    */
    ...
    'sp' => [
        ...
        */
        ...
        'entityId' => env('SAML2_SP_ENTITY_ID', 'https://wwwtest.pcc.edu/library/instruction-requests/public/saml2/metadata'),
        ...
        */
        ...
        'assertionConsumerService' => [
            'url' => 'https://wwwtest.pcc.edu/library/instruction-requests/public/saml2/acs',
        ],
        ...
        */
        ...
        'singleLogoutService' => [
            'url' => 'https://wwwtest.pcc.edu/library/instruction-requests/public/saml2/sls',
        ],
    ],
    ...
    */
    ...
    'contactPerson' => [
        'technical' => [
            'givenName' => env('SAML2_CONTACT_TECHNICAL_NAME', ''),
            'emailAddress' => env('SAML2_CONTACT_TECHNICAL_EMAIL', '')
        ],
        'support' => [
            'givenName' => env('SAML2_CONTACT_SUPPORT_NAME', ''),
            'emailAddress' => env('SAML2_CONTACT_SUPPORT_EMAIL', '')
        ],
    ],
    ...
    */
    ...
    'organization' => [
        'en-US' => [
            'name' => env('SAML2_ORGANIZATION_NAME', 'Library Instruction System'),
            'displayname' => env('SAML2_ORGANIZATION_NAME', 'Library Instruction'),
            'url' => env('SAML2_ORGANIZATION_URL', 'https://wwwtest.pcc.edu/library/instruction-requests')
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | General setting of the identity provider.
    |
    */
    'idp' => [
        /*
        |--------------------------------------------------------------------------
        | Identifier (URI) of the IdP entity.
        |--------------------------------------------------------------------------
        |
        | e.g. https://idp.example.com/metadata.xml
        |
        */
        'entityId' => 'https://authenticate-test.pcc.edu/identity/metadata/saml2',
        ...
        |--------------------------------------------------------------------------
        |
        | URL Location where the <AuthnRequest> from the SP will be returned,
        | using HTTP-Redirect binding.
        |
        */
        'singleSignOnService' => [
            'url' => 'https://authenticate-test.pcc.edu/samlsso',
        ],
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Usually x509cert of the IdP are provided by files placed at
        | the certs folder. But we can also provide them with the following parameter.
        |
        */
        'x509cert' => env('SAML2_IDP_CERT_x509',''),
    ],
