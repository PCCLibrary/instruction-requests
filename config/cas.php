...
return [
    ...
    */
    'cas_hostname' => env('CAS_HOSTNAME', 'authenticate.pcc.edu'),
    ...
    */
    'cas_real_hosts' => env('CAS_REAL_HOSTS', 'authenticate.pcc.edu'),
    ...
    */
    'cas_client_service' => env('CAS_CLIENT_SERVICE', 'http://localhost:8080/library/instruction-requests/'),
...
//    'cas_validation' => env('CAS_VALIDATION', 'ca'),
    ...
    */
    //'cas_cert' => env('CAS_CERT', '/path/to/your/cacert.pem'),
    ...
    */
    ...
    | Empty is fine
    */
    'cas_login_url' => env('CAS_LOGIN_URL', 'https://authenticate.pcc.edu/cas/login'),
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url' => env('CAS_LOGOUT_URL', 'https://authenticate.pcc.edu/cas/logout'),
    ...
    */
     ...
     */
    'cas_session_domain' => env('APP_DOMAIN', 'pcc.edu'),
